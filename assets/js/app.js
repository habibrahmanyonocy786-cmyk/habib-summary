...
const Habib = {
  ...
  books: [
    { id:'atomic', title:'کتاب عادات اتمی (Atomic Habits)', author:'جیمز کلیر (James Clear)',
      ...
      questions:[
        ...
        { q:'بر اساس کتاب، چه چیزی باعث می‌شود عادت‌ها پایدار بمانند؟', options:['انگیزه بالا','اراده قوی','طراحی محیط و سیستم مناسب','تنبیه خود'], correct:2 },
        { q:'قانون چهارم تغییر رفتار (Make it Satisfying) یعنی چه؟', options:['کار سخت انجام بده','پاداش فوری به عادت خوب بده','از تنبیه استفاده کن','اهداف بزرگ تعیین کن'], correct:1 }
      ]},
    { id:'richdad', title:'کتاب پدر پولدار پدر بی‌پول (Rich Dad Poor Dad)', author:'رابرت کیوساکی (Robert Kiyosaki)',
      ...
      questions:[
        ...
        { q:'تفاوت "دارایی" (Asset) و "بدهی" (Liability) از نظر کیوساکی چیست؟', options:['دارایی قابل فروش است','دارایی پول به جیب شما می‌آورد، بدهی پول از جیب شما خارج می‌کند','بدهی همیشه بد است','هیچ فرقی ندارند'], correct:1 },
        { q:'"چهارگانه جریان نقدی" (Cashflow Quadrant) شامل چه بخش‌هایی است؟', options:['کارمند، مدیر، رئیس، صاحب کسب و کار','کارمند، خوداشتغال، صاحب کسب و کار، سرمایه‌گذار','فروشنده، خریدار، تولیدکننده، توزیع‌کننده','فقیر، متوسط، ثروتمند، فوق‌ثروتمند'], correct:1 }
      ]},
    { id:'habits7', title:'کتاب هفت عادت مردم مؤثر (7 Habits)', author:'استیون کاوی (Stephen Covey)',
      ...
      questions:[
        ...
        { q:'عادت "اول گوش بعد صحبت کن" (Seek First to Understand) یعنی چه؟', options:['قبل از حرف زدن خوب فکر کن','اول گوش بده تا طرف مقابل را بفهمی بعد صحبت کن','فقط گوش بده و حرف نزن','بعد از گوش دادن نظر خود را تحمیل کن'], correct:1 },
        { q:'عادت "تیز کردن اره" (Sharpen the Saw) به چه معناست؟', options:['ابزارهای خود را تیز کن','بهبود و تجدید قوا در چهار بعد جسمی، روحی، ذهنی و اجتماعی','سخت‌تر کار کن','همیشه در حال یادگیری باش'], correct:1 }
      ]},
    { id:'thinking', title:'کتاب تفکر سریع و کند (Thinking, Fast and Slow)', author:'دنیل کانمن (Daniel Kahneman)',
      emoji:'🧠', color:'from-purple-500 to-violet-600',
      summary:'دنیل کانمن، برنده جایزه نوبل اقتصاد، در این کتاب دو سیستم تفکر را معرفی می‌کند: سیستم ۱ (تفکر سریع، شهودی و احساسی) و سیستم ۲ (تفکر کند، منطقی و تحلیلی). او نشان می‌دهد که چگونه سوگیری‌های شناختی مانند لنگر انداختن، در دسترس بودن و اعتماد بیش از حد، قضاوت و تصمیم‌گیری ما را تحت تأثیر قرار می‌دهند.',
      questions:[
        { q:'سیستم ۱ در تفکر چه ویژگی‌هایی دارد؟', options:['سریع، شهودی و خودکار','کند، منطقی و تحلیلی','نیازمند تلاش ذهنی زیاد','همیشه درست تصمیم می‌گیرد'], correct:0 },
        { q:'سوگیری "لنگر انداختن" (Anchoring) یعنی چه؟', options:['تکیه بیش از حد بر اولین اطلاعات دریافتی','اعتماد بیش از حد به خود','فکر کردن به گذشته','تأثیر احساسات بر تصمیم‌گیری'], correct:0 },
        { q:'به گفته کانمن، چه زمانی سیستم ۲ فعال می‌شود؟', options:['همیشه فعال است','وقتی کار ساده و تکراری است','وقتی با مسئله پیچیده یا غیرمنتظره مواجه می‌شویم','هرگز فعال نمی‌شود'], correct:2 },
        { q:'"خطای داستان‌سرایی" (Narrative Fallacy) چیست؟', options:['دروغ گفتن در داستان‌ها','ساختن داستان‌های ساده و قانع‌کننده برای توضیح رویدادهای تصادفی','نوشتن داستان‌های طولانی','تکرار داستان‌های قدیمی'], correct:1 },
        { q:'اثر "در دسترس بودن" (Availability Heuristic) یعنی چه؟', options:['تخمین زدن احتمال رویدادها بر اساس آسانی یادآوری مثال‌ها','در دسترس بودن همه گزینه‌ها','انتخاب آسان‌ترین گزینه','جستجوی اطلاعات در دسترس'], correct:0 }
      ]},
    { id:'clear-thinking', title:'کتاب هنر شفاف اندیشیدن (The Art of Thinking Clearly)', author:'رولف دوبلی (Rolf Dobelli)',
      emoji:'🔍', color:'from-cyan-500 to-blue-600',
      summary:'رولف دوبلی در این کتاب ۹۹ خطای شناختی و سوگیری را توضیح می‌دهد که باعث می‌شوند انسان‌ها تصمیمات نادرست بگیرند. از سوگیری تأیید تا خطای بقا، از توهم کنترل تا مغالطه هزینه هدررفته. دوبلی نشان می‌دهد که آگاهی از این خطاها اولین گام برای تصمیم‌گیری بهتر است.',
      questions:[
        { q:'سوگیری تأیید (Confirmation Bias) یعنی چه؟', options:['رد کردن اطلاعات جدید','جستجو و تفسیر اطلاعات به گونه‌ای که باورهای قبلی ما را تأیید کند','تأیید همه چیز','پذیرش نظرات دیگران'], correct:1 },
        { q:'"خطای بقا" (Survivorship Bias) چیست؟', options:['بقای بهترین‌ها','تمرکز بر موفقیت‌ها و نادیده گرفتن شکست‌ها','زنده ماندن در شرایط سخت','بقای گونه‌ها'], correct:1 },
        { q:'مغالطه هزینه هدررفته (Sunk Cost Fallacy) یعنی چه؟', options:['ادامه دادن یک کار به دلیل سرمایه‌گذاری قبلی حتی اگر منطقی نباشد','پس‌انداز کردن پول','هدر ندادن منابع','سرمایه‌گذاری هوشمندانه'], correct:0 },
        { q:'"توهم کنترل" (Illusion of Control) چیست؟', options:['کنترل کامل بر زندگی','باور به اینکه می‌توانیم رویدادهای تصادفی را کنترل کنیم','نداشتن کنترل بر هیچ چیز','کنترل دیگران'], correct:1 },
        { q:'اثر "تأیید اجتماعی" (Social Proof) یعنی چه؟', options:['تأیید دیگران','وقتی افراد رفتار دیگران را تقلید می‌کنند چون فکر می‌کنند درست است','اثبات اجتماعی','تأیید گروه'], correct:1 }
      ]},
    { id:'compound', title:'کتاب اثر مرکب (The Compound Effect)', author:'دارن هاردی (Darren Hardy)',
      emoji:'📈', color:'from-green-500 to-emerald-600',
      summary:'دارن هاردی نشان می‌دهد که چگونه انتخاب‌های کوچک و روزمره، در طول زمان به نتایج بزرگ و خارق‌العاده منجر می‌شوند. او بر قدرت عادت‌های کوچک، پیگیری مداوم، و شتاب گرفتن از تغییرات تدریجی تأکید دارد. اثر مرکب همان سود مرکب در زندگی است.',
      questions:[
        { q:'اثر مرکب (Compound Effect) در زندگی یعنی چه؟', options:['تغییرات بزرگ در یک روز','نتایج حاصل از تکرار کارهای کوچک در طول زمان','سود بانکی','اثرگذاری بر دیگران'], correct:1 },
        { q:'به گفته دارن هاردی، چند درصد از موفقیت به دانش مربوط است؟', options:['۵۰٪','۲۵٪','۵٪','۷۵٪'], correct:2 },
        { q:'پیگیری (Tracking) در روش اثر مرکب چه نقشی دارد؟', options:['بی‌فایده است','به اندازه‌گیری و مشاهده پیشرفت کمک می‌کند','فقط برای ورزش است','وقت تلف کردن است'], correct:1 },
        { q:'مفهوم "شتاب" (Momentum) در کتاب یعنی چه؟', options:['دویدن سریع','تغییرات کوچک که با گذشت زمان سرعت می‌گیرند','حرکت فیزیکی','انتقال انرژی'], correct:1 },
        { q:'کدام یک از موارد زیر از اصول کلیدی اثر مرکب است؟', options:['تغییرات بزرگ آنی','ایجاد عادت‌های کوچک و مداوم','انتظار برای فرصت مناسب','تکیه بر استعداد ذاتی'], correct:1 }
      ]},
    { id:'cheese', title:'کتاب چه کسی پنیر مرا جابجا کرد (Who Moved My Cheese)', author:'اسپنسر جانسون (Spencer Johnson)',
      emoji:'🧀', color:'from-orange-500 to-red-600',
      summary:'این کتاب تمثیلی کوتاه درباره موش‌هایی به نام اسنیف و اسکری و آدم‌کوچولوهایی به نام هیم و هاو است که در پیچ و خم هزارتو به دنبال پنیر (که نماد خواسته‌ها و اهداف زندگی است) می‌گردند. پیام اصلی این است که تغییر اجتناب‌ناپذیر است و ما باید خود را با آن وفق دهیم.',
      questions:[
        { q:'در کتاب "چه کسی پنیر مرا جابجا کرد"، پنیر نماد چیست؟', options:['غذا','آنچه در زندگی می‌خواهیم (شغل، پول، خوشبختی)','پاداش','خوراکی'], correct:1 },
        { q:'کدام شخصیت داستان زودتر متوجه تغییر شد؟', options:['هیم','هاو','اسنیف','همه با هم'], correct:2 },
        { q:'پیام اصلی کتاب "چه کسی پنیر مرا جابجا کرد" چیست؟', options:['پنیر مهم‌ترین چیز است','تغییر اجتناب‌ناپذیر است و باید خود را وفق دهیم','هزارتو جای خطرناکی است','موش‌ها باهوش هستند'], correct:1 },
        { q:'هاو در طول داستان چه درس مهمی یاد گرفت؟', options:['چگونه پنیر بیشتری پیدا کند','ترس از تغییر را کنار بگذارد و به دنبال فرصت‌های جدید برود','چگونه از پنیر محافظت کند','چگونه گم نشود'], correct:1 },
        { q:'نوشته روی دیوار "اگر از ترس خود دست نکشی..." ادامه آن چیست؟', options:['هرگز موفق نخواهی شد','همیشه گرسنه خواهی ماند','هرگز پنیر جدیدی پیدا نخواهی کرد','در هزارتو گم خواهی شد'], correct:2 }
      ]},
    { id:'meaning', title:'کتاب انسان در جستجوی معنا (Man\'s Search for Meaning)', author:'ویکتور فرانکل (Viktor Frankl)',
      emoji:'🕊️', color:'from-indigo-500 to-purple-600',
      summary:'ویکتور فرانکل، روانپزشک و بازمانده اردوگاه‌های کار اجباری نازی‌ها، در این کتاب از تجربیات خود در اردوگاه و نظریه "معنا درمانی" (Logotherapy) می‌گوید. او معتقد است نیروی محرکه اصلی انسان، میل به یافتن معنا در زندگی است و حتی در بدترین شرایط می‌توان معنا را یافت.',
      questions:[
        { q:'نظریه "معنا درمانی" (Logotherapy) بر چه اساسی استوار است؟', options:['لذت‌طلبی','قدرت‌طلبی','میل به یافتن معنا در زندگی','تأمین نیازهای اولیه'], correct:2 },
        { q:'ویکتور فرانکل معتقد است انسان می‌تواند معنا را از چند راه پیدا کند؟', options:['یک راه','سه راه: کار، عشق و رنج','پنج راه','دو راه: پول و شهرت'], correct:1 },
        { q:'به گفته فرانکل، واکنش ما به رنج چه اهمیتی دارد؟', options:['هیچ اهمیتی ندارد','رنج را نادیده بگیریم','نگرش ما به رنج آخرین آزادی انسان است','رنج را انکار کنیم'], correct:2 },
        { q:'جمله معروف فرانکل: "آنان که چرایی زندگی را دارند..." ادامه آن چیست؟', options:['هرگز نمی‌میرند','با هر چگونگی کنار می‌آیند','همیشه خوشبخت هستند','به آرامش می‌رسند'], correct:1 },
        { q:'کدام یک از موارد زیر از اصول Logotherapy نیست؟', options:['انسان آزاد است که نگرش خود را انتخاب کند','معنا در رنج یافت می‌شود','لذت هدف نهایی زندگی است','اراده معنا نیروی محرکه انسان است'], correct:2 }
      ]},
    { id:'power-habit', title:'کتاب قدرت عادت (The Power of Habit)', author:'چارلز دوهیگ (Charles Duhigg)',
      emoji:'🔄', color:'from-pink-500 to-rose-600',
      summary:'چارلز دوهیگ در این کتاب توضیح می‌دهد که عادت‌ها چگونه کار می‌کنند و چگونه می‌توانیم آن‌ها را تغییر دهیم. او "حلقه عادت" (Cue-Routine-Reward) را معرفی می‌کند و نشان می‌دهد که با شناسایی محرک و پاداش می‌توان روال (Routine) را تغییر داد. مثال‌هایی از شرکت‌های بزرگ و جنبش‌های اجتماعی نیز ارائه می‌شود.',
      questions:[
        { q:'حلقه عادت از سه بخش تشکیل شده است: محرک، روال و ...', options:['نتیجه','پاداش','هدف','عادت'], correct:1 },
        { q:'به گفته دوهیگ، "عادت کلیدی" (Keystone Habit) چیست؟', options:['سخت‌ترین عادت','عادتی که تغییر آن منجر به زنجیره‌ای از تغییرات دیگر می‌شود','عادت روزانه','عادت بد'], correct:1 },
        { q:'قانون طلایی تغییر عادت چیست؟', options:['محرک و پاداش را حفظ کن، روال را تغییر بده','همه چیز را تغییر بده','از صفر شروع کن','عادت را حذف کن'], correct:0 },
        { q:'کدام شرکت با درک قدرت عادت‌ها توانست تبلیغات خود را متحول کند؟', options:['اپل','P&G (Procter & Gamble)','نایک','کوکاکولا'], correct:1 },
        { q:'چقدر زمان لازم است تا یک عادت جدید شکل بگیرد؟', options:['۲۱ روز ثابت','دوهیگ می‌گوید زمان ثابتی وجود ندارد و به عوامل مختلف بستگی دارد','۳۰ روز','۶۶ روز'], correct:1 }
      ]},
    { id:'start-why', title:'کتاب شروع با چرا (Start with Why)', author:'سایمون سینک (Simon Sinek)',
      emoji:'🎯', color:'from-yellow-500 to-amber-600',
      summary:'سایمون سینک در این کتاب مفهوم "دایره طلایی" (Golden Circle) را معرفی می‌کند: چرا (Why) - چگونگی (How) - چه (What). او استدلال می‌کند که سازمان‌ها و رهبران الهام‌بخش از درون به بیرون فکر می‌کنند و با "چرا" شروع می‌کنند. نمونه‌هایی از اپل، مارتین لوتر کینگ و برادران رایت ارائه می‌شود.',
      questions:[
        { q:'دایره طلایی (Golden Circle) از چند بخش تشکیل شده است؟', options:['۲ بخش','۳ بخش: چرا، چگونگی، چه','۴ بخش','۵ بخش'], correct:1 },
        { q:'بیشتر شرکت‌ها از کدام لایه دایره طلایی شروع می‌کنند؟', options:['چرا (Why)','چگونگی (How)','چه (What)','از هیچکدام'], correct:2 },
        { q:'رهبران الهام‌بخش و سازمان‌های موفق از کجا شروع می‌کنند؟', options:['از "چرا" (Why)','از محصول','از قیمت','از بازاریابی'], correct:0 },
        { q:'سایمون سینک از کدام برادران به عنوان مثال استفاده می‌کند؟', options:['برادران وایت','برادران رایت','برادران مارکس','برادران وارنر'], correct:1 },
        { q:'به گفته سینک، مشتریان چه چیز را می‌خرند؟', options:['محصول','خدمت','چرایی و باور شما','قیمت مناسب'], correct:2 }
      ]}
  ],
  ...
  startMixed() {
    ...
    this.state.mQuestions = all.slice(0,10);
  ...
  renderMixed() {
    if (!this.state.mStarted) {
      this.els.mixed.innerHTML = `<div class="text-center py-16 bg-white rounded-xl border border-gray-200"><div class="text-5xl mb-4">🧪</div><h3 class="text-xl font-bold text-gray-800 mb-2">آزمون ترکیبی</h3><p class="text-gray-500 mb-6">۱۰ سوال تصادفی از تمام کتاب‌ها (از ۱۰ کتاب)</p><button class="px-6 py-3 rounded-lg bg-gray-800 text-white font-medium hover:bg-gray-700" onclick="Habib.startMixed()">شروع آزمون</button></div>`;
      return;
    }
